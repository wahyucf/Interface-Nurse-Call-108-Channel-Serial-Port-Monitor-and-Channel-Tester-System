...
Serial.println("Loop");
  if (Serial3.available() > 0)
  {
    ...
    if (flag1 == HIGH) //< received
    {
      ...
      {
        //Serial3.println();
        //Serial3.println("Input is:");
        //Serial3.println(myArray);
        {
          IsiBerita = myArray;
          IsiBerita = IsiBerita.substring(1);
          //Serial3.println("Data is:");
          //Serial3.println(IsiBerita);
        }
        flag1 = LOW;
    ...
    if (flag1 == LOW) //< received
    {
      ...
      switch (id) {
        case 1:
          DispBed(IsiBerita);
          //Serial3.println("Display Bed is:");
          //Serial3.println(IsiBerita);

          Serial3.begin(9600); break;
        case 2:
          DispKM(IsiBerita);
          //Serial3.println("Display KM is:");
          //Serial3.println(IsiBerita);
          Serial3.begin(9600); break;
        case 3:
          DispCBlue(IsiBerita);
          //Serial3.println("Display CB is:");
          //Serial3.println(IsiBerita);
          Serial3.begin(9600); break;
        case 4:
          DispSA(IsiBerita);
          //Serial3.println("Display SA is:");
          //Serial3.println(IsiBerita);
          Serial3.begin(9600); break;
        case 5:
          DispBed(IsiBerita);
